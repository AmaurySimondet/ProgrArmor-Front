...
function Dashboard() {
    ...
    function exportTableToCSV(html, filename) {
        ...
        csv.push(["Ce tableau est une exportation de Progarmor"])
        csv.push(["ProgArmor outil ultime de la progression sportive: journal et historique programme statistiques de tes amis et autre"])
        csv.push(["http://192.168.1.80:8800/"])
        csv.push([])
